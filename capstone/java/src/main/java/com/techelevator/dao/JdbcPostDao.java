...
//        TODO check the names of the columns in insert SQL
        String sql = "INSERT INTO posts (user_id, user_game_id, image, title, comments, tags, rating, public_private) VALUES (?, ?, ?, ?, ?, ?,?,?) RETURNING post_id";
        Integer postId = jdbcTemplate.queryForObject(sql, Integer.class, createPost.getUserId(),createPost.getUserGameId(),createPost.getImageUrl(), createPost.getTitle(), createPost.getComments(), createPost.getTags(), createPost.getRating(), createPost.isPublicPrivate());
